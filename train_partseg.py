...
def main(args):
    ...
    root = 'data/shapenetcore_partanno_segmentation_benchmark_v0_normal/shapenetcore_partanno_segmentation_benchmark_v0_normal/'
    ...
    classifier = MODEL.get_model(num_part, normal_channel=args.normal, use_hosa=True, code=['MAX', 'OM1', 'CM2', 'CM3', 'CM4'], use_sa=True, agg_type=0).cuda()
