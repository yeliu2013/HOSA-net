...
from data_utils.ModelNetDataLoaderH5N import ModelNetDataLoader
#from data_utils.ModelNetDataLoaderH5N import ModelNet40
...
def main(args):
    ...
    #train_dataset = ModelNet40(partition='train', num_points=args.num_point)
    #test_dataset = ModelNet40(partition='test', num_points=args.num_point)
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        for batch_id, (points, target) in tqdm(enumerate(trainDataLoader, 0), total=len(trainDataLoader), smoothing=0.9):
            ...
            loss = criterion(pred, target.long().squeeze(), trans_feat)
            pred_choice = pred.data.max(1)[1]
